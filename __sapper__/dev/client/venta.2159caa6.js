...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 26, 0, 777);
			attr_dev(div0, "class", "animacion");
			add_location(div0, file, 25, 4, 737);
			attr_dev(div1, "class", "container svelte-rdjbln");
			add_location(div1, file, 24, 0, 708);
		},
		m: function mount(target, anchor) {

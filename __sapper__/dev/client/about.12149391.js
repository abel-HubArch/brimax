import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, a as add_render_callback, v as validate_slots, g as globals, b as space, e as element, c as create_component, q as query_selector_all, f as detach_dev, h as claim_space, j as claim_element, k as children, m as claim_component, n as attr_dev, o as add_location, p as insert_dev, r as append_dev, u as mount_component, w as listen_dev, z as transition_out, I as check_outros, x as transition_in, y as create_bidirectional_transition, A as destroy_component, H as group_outros, t as text, l as claim_text } from './client.52bfd6a6.js';
import { O as Overoles } from './overoles.e539c46c.js';
import { D as Disenos_personalizables } from './disenos_personalizables.8b08c9bf.js';
import { s as slide } from './index.60a44412.js';
import { L as Logo } from './logo.1744d03f.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1kujnz1");
			add_location(h1, file, 95, 1, 1818);
			attr_dev(hr, "class", "svelte-1kujnz1");
			add_location(hr, file, 95, 47, 1864);
			attr_dev(div0, "class", "text_welcome2 svelte-1kujnz1");
			add_location(div0, file, 94, 1, 1789);
			attr_dev(div1, "class", "menu svelte-1kujnz1");
			attr_dev(div1, "id", "menu");
			add_location(div1, file, 93, 3, 1742);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "animacion");
			add_location(div1, file, 90, 0, 1680);
			attr_dev(div2, "class", "contenedor svelte-1kujnz1");
			attr_dev(div2, "id", "contenedor");
			add_location(div2, file, 84, 0, 1557);
		},
		m: function mount(target, anchor) {

...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file, 69, 3, 1531);
			attr_dev(label0, "for", "");
			attr_dev(label0, "class", "svelte-1vnnd2k");
			add_location(label0, file, 73, 4, 4212);
			add_location(br0, file, 73, 32, 4240);
			attr_dev(input0, "name", "nombres");
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", "Nombres");
			input0.required = true;
			attr_dev(input0, "class", "svelte-1vnnd2k");
			add_location(input0, file, 74, 4, 4249);
			add_location(br1, file, 74, 69, 4314);
			attr_dev(label1, "for", "");
			attr_dev(label1, "class", "svelte-1vnnd2k");
			add_location(label1, file, 75, 4, 4323);
			add_location(br2, file, 75, 34, 4353);
			attr_dev(input1, "type", "number");
			input1.required = true;
			attr_dev(input1, "class", "svelte-1vnnd2k");
			add_location(input1, file, 76, 4, 4362);
			add_location(br3, file, 76, 34, 4392);
			attr_dev(label2, "for", "");
			attr_dev(label2, "class", "svelte-1vnnd2k");
			add_location(label2, file, 77, 4, 4401);
			add_location(br4, file, 77, 44, 4441);
			attr_dev(input2, "type", "text");
			attr_dev(input2, "placeholder", "(Opcional)");
			attr_dev(input2, "class", "svelte-1vnnd2k");
			add_location(input2, file, 78, 4, 4450);
			add_location(br5, file, 78, 48, 4494);
			attr_dev(label3, "for", "pregunta");
			attr_dev(label3, "class", "svelte-1vnnd2k");
			add_location(label3, file, 79, 4, 4503);
			add_location(br6, file, 79, 54, 4553);
			...
			add_location(textarea, file, 80, 4, 4562);
			add_location(br7, file, 80, 78, 4636);
			add_location(button, file, 80, 83, 4641);
			attr_dev(form, "action", "");
			attr_dev(form, "class", "contactoF svelte-1vnnd2k");
			attr_dev(form, "id", "AbrirContacto");
			add_location(form, file, 72, 0, 4154);
			add_location(h1, file, 82, 3, 4676);
			attr_dev(div0, "id", "fb-root");
			add_location(div0, file, 86, 6, 4746);
			script.async = true;
			script.defer = true;
			...
			add_location(script, file, 87, 6, 4777);
			...
			add_location(div1, file, 88, 6, 4924);
			add_location(br8, file, 88, 169, 5087);
			attr_dev(div2, "class", "contactanos svelte-1vnnd2k");
			add_location(div2, file, 68, 4, 1485);
			attr_dev(div3, "class", "contenedor svelte-1vnnd2k");
			add_location(div3, file, 66, 3, 1441);
		},
...
export default Blog;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
